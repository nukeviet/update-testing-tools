...
VERSIONS=(
  "24f8f27d1481a685e1f9b8271bc0cf0df0484d5c" # 4.3.03
  # "head"                                     # latest
)
VERSIONS_NAME=(
  "4.3.03"
...
LASTESTUPDATEVERSION="to-4.5.04" # Nhánh update module mới nhất để test cập nhật

NUKEVIETREPOURL="https://github.com/nukeviet/nukeviet.git" # Repo NukeViet để test
MODULEREPOURL="https://github.com/nukeviet/module-organs.git" # Repo chứa module để test
UPDATEREPOURL="https://github.com/nukeviet/module-organs.git" # Repo chứa gói cập nhật để test

# Cho phép truyền tham số đầu tiên là tên phiên bản để chạy từ đó trở đi, ví dụ: bash organs-4.5.sh 4.3.03
START_VERSION="$1"
START_INDEX=0
...
for i in "${!VERSIONS[@]}"; do
  ...
  php $DIR_PATH/vendor/bin/codecept run -g install-module-organs
